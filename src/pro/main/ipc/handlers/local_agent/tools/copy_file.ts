...
const copyFileSchema = z.object({
  from: z
    .string()
    .describe(
      "The source file path (can be a .minerva/media path or a path relative to the app root)",
    ),
...
export const copyFileTool: ToolDefinition<z.infer<typeof copyFileSchema>> = {
  name: "copy_file",
  description:
    "Copy a file from one location to another. Can copy uploaded attachment files (from .minerva/media) into the codebase, or copy files within the codebase.",
